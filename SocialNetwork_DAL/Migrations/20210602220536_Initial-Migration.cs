    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BloggerSubscribers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BloggerSubscribers_AspNetUsers_BloggerId",
                        column: x => x.BloggerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BloggerSubscribers_AspNetUsers_SubscriberId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Work = table.Column<string>(type: "nvarchar(150)", nullable: true),
                    Hobby = table.Column<string>(type: "nvarchar(150)", nullable: true),
                    About = table.Column<string>(type: "nvarchar(300)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BloggerSubscribers_BloggerId",
                table: "BloggerSubscribers",
                column: "BloggerId");

            migrationBuilder.CreateIndex(
                name: "IX_BloggerSubscribers_SubscriberId",
                table: "BloggerSubscribers",
                column: "SubscriberId");
